            ...
            <StyledNavigationContainer>
                ...
                <StyledNavigation>
                    <StyledUL>
                        ...
                        <StyledLi>
                            {isLoggedIn ? <StyledLink secondary="true"  to="/">Sign Out</StyledLink> : <a href={`https://discord.com/api/oauth2/authorize?client_id=850815958943268904&redirect_uri=https%3A%2F%2Friftq.com&response_type=code&scope=email%20identify`}>Sign In</a>}
                        </StyledLi>
                    </StyledUL>
                </StyledNavigation>
            </StyledNavigationContainer>
